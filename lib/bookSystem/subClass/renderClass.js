...
var RenderClass = /** @class */ (function () {
    ...
    RenderClass.prototype.render = function (path, data, template) {
        var _this = this;
        if (data === void 0) { data = {}; }
        ...
        return this.ejsRender(path, data).then(function (str) {
            //@ts-ignore
            var content = template ? _this.parent.Scan.splitTemplate(str) : _this.parent.Scan.splitStr(str).content;
