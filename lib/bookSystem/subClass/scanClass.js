...
var Scan = /** @class */ (function () {
    ...
    /** 得到模板内容 */
    Scan.prototype.splitTemplate = function (str, filePath) {
        var content = this.splitStr(str, filePath);
        var ret = [];
        var reg = /<!-- template start -->\n((.|\n)+?)<!-- template end -->/g;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.loadSummary(path, catalog)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, catalog.children];
                }
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < summary_array_1.length)) return [3 /*break*/, 6];
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.loadSummary(real_path, new_data)];
                    case 4:
                        _a.sent();
    ...
    Scan.prototype.scanAllRespository = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_a) {
                files = this.get_all_files_in_dir(this.parent.localRespository, [/^_/, /_draft/, /^readme.md$/i], [/\.md$/]);
