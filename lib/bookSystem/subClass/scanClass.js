...
var Scan = /** @class */ (function () {
    ...
    /** 目录扫描 */
    Scan.prototype.scanCatalogues = function () {
    };
    ...
    Scan.prototype.loadSummary = function (path, parent) {
        ...
        if (!fs.existsSync(path)) //不存在
            return null;
        parent.children = [];
        var summary_array = js_yaml_1.default.safeLoad(fs.readFileSync(summaryPath, { encoding: 'utf-8' }));
        //遍历
        if (!summary_array)
            return;
        for (var _i = 0, summary_array_1 = summary_array; _i < summary_array_1.length; _i++) {
            var item = summary_array_1[_i];
            var subpath = item.path, title = item.title;
            var real_path = void 0;
            try {
    ...
    Scan.prototype.scanAllRespository = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                files = this.get_all_files_in_dir(this.parent.localRespository, [/^_/], [/\.md$/]);
