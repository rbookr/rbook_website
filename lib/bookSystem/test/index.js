...
var bookSystem_1 = __importDefault(require("../bookSystem"));
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, book.Scan.scanAllRespository()];
                case 1:
                    asn = _a.sent();
                    book.Db.findOne_by_id('cc0a9b6d564a9385eda3a23053a7b8b0').then(function (doc) {
                        console.log("================");
                        console.log(doc);
                        console.log("================");
                    });
